    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 text-center feature-box-10 sm-margin-20px-bottom wow fadeInUp last-paragraph-no-margin">
                ...
                <div class="alt-font text-medium text-extra-dark-gray margin-10px-bottom">Konluzioni 1</div>
            ...
            <div class="col-12 col-md-4 text-center feature-box-10 sm-margin-20px-bottom wow fadeInUp last-paragraph-no-margin" data-wow-delay="0.2s">
                ...
                <div class="alt-font text-medium text-extra-dark-gray margin-10px-bottom">Konluzioni 2</div>
                <p class="width-75 md-width-85 mx-auto">Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.</p>
            </div>
            <!-- end process step item -->
            <!-- start process step item -->
            <div class="col-12 col-md-4 text-center feature-box-10 wow fadeInUp last-paragraph-no-margin" data-wow-delay="0.4s">
                ...
                <div class="alt-font text-medium text-extra-dark-gray margin-10px-bottom">Konluzioni 3</div>
                <p class="width-75 md-width-85 mx-auto">Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.</p>
            </div>
            <!-- end process step item -->
        </div>
        <div class="row margin-40px-top">
            ...
            <div class="col-12 col-md-4 text-center feature-box-10 sm-margin-20px-bottom wow fadeInUp last-paragraph-no-margin">
                ...
                <div class="alt-font text-medium text-extra-dark-gray margin-10px-bottom">Konluzioni 4</div>
                <p class="width-75 md-width-85 mx-auto">Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.</p>
            </div>
            <!-- end process step item -->
            <!-- start process step item -->
            <div class="col-12 col-md-4 text-center feature-box-10 sm-margin-20px-bottom wow fadeInUp last-paragraph-no-margin " data-wow-delay="0.2s">
                ...
                <div class="alt-font text-medium text-extra-dark-gray margin-10px-bottom">Konluzioni 5</div>
                <p class="width-75 md-width-85 mx-auto">Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.</p>
            </div>
            <!-- end process step item -->
            <!-- start process step item -->
            <div class="col-12 col-md-4 text-center feature-box-10 wow fadeInUp last-paragraph-no-margin" data-wow-delay="0.4s">
                ...
                <div class="alt-font text-medium text-extra-dark-gray margin-10px-bottom">Konluzioni 6</div>
                <p class="width-75 md-width-85 mx-auto">Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.</p>
            </div>
            <!-- end process step item -->
        </div>
