...
<html class="no-js" lang="en">
    <head>
        <!-- title -->
        <title>MediaLook Title</title>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1" />
        <meta name="author" content="ThemeZaa">
        <!-- description -->
        <meta name="description" content="Pershkrimi i projektit te Medialook">
        <!-- keywords -->
        <meta name="keywords" content="vendos,fjalet,kryesore,kyce,qe,do,te,kete,projekti">
        <!-- favicon -->
                    ...
                    <div class="col accordion-menu pr-0 pr-md-3">
                        ...
                        <div class="navbar-collapse collapse justify-content-end" id="navbar-collapse-toggle-1">
                            <ul id="accordion" class="nav navbar-nav navbar-left no-margin alt-font text-normal" data-in="fadeIn" data-out="fadeOut">
                                <!-- start menu item -->
                                <li class="dropdown">
                                    <a href="#">Kreu</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                </li>
                                <li>
                                    <a href="#menu1" class="inner-link">Item 1</a>
                                </li>
                                <li>
                                    <a href="#menu2" class="inner-link">Item 5</a>
                                </li>
                                <li>
                                    <a href="#menu3" class="inner-link">Item 2</a>
                                </li>
                                <li>
                                    <a href="#menu4" class="inner-link">Item 3</a>
                                </li>
                                <li>
                                    <a href="#menu5" class="inner-link">Item 4</a>
                                </li>
